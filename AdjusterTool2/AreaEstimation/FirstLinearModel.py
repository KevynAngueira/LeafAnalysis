...
# Save the figure
plt.savefig(f"Result/LinearRegression/First/Linear_Regression_{num_base_width_segments}.png")
...
with open(f'Result/LinearRegression/First/Linear_Regression_{num_base_width_segments}.json', 'w') as f:
