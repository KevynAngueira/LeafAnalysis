...
# Evaluate LOOCV R² for predicting each segment from previous segments
segment_r2s = []
...
# Print results
print("Gradient Boosting + LOOCV R² for predicting each segment from previous segments:")
...
plt.plot(segments, r2_values, marker='o', linestyle='-', color='yellow')
plt.title('LOOCV R² for Gradient Boosting Regressor')
...
plt.savefig("Metrics/GradientBoosting_loocv_r2s_plot.png")
