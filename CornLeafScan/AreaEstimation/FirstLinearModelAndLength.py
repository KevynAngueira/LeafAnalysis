...
plt.title(f"Linear Regression with Length ({num_base_width_segments} Base Widths)")
plt.grid(True)
plt.tight_layout()

# Save the figure
plt.savefig(f"Result/LinearRegression/First/Linear_Regression_Length_{num_base_width_segments}.png")
...
with open(f'Result/LinearRegression/First/Linear_Regression_Length_{num_base_width_segments}.json', 'w') as f:
