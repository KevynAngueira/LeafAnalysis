...
# Evaluate LOOCV R² for predicting each segment from its previous segments using Random Forest
segment_r2s = []
...
# Print results
print("Random Forest + LOOCV R² for predicting each segment from previous segments:")
...
plt.title('Random Forest LOOCV R² for Predicting Each Segment from Previous Segments')
...
plt.savefig("Metrics/RandomForest_loocv_r2s_plot.png")
