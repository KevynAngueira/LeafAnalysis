...
class SliceAreaCalculator:
    def __init__(self, window_dimensions = (6.5, 1.0)):
        self.slice_area = window_dimensions[0]*window_dimensions[1]        
        self.leaf_area_arr = []
