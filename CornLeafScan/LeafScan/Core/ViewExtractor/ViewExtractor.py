...
class ViewExtractor:
    def __init__(self, view_config: ViewExtractorConfig = None):
        if view_config is None:
            view_config = ViewExtractorConfig()
        self.__dict__.update(vars(view_config))
        
        self.toolMask = LABMask(self.tool_bounds)
        self.accepted_rect = None
    ...
    def Extract(self, image, display=False, **kwargs):
        ...
        if target_rect is not None:
            self.accepted_rect = target_rect
