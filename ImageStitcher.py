...
class ImageStitcher:
    def __init__(self, contour_threshold=10, band_height=20):
    ...
    def stitch_images(self, image1, image2, last_size):
        """ 
        ...
        cropped1, bbox1 = self.crop_leaf(template)
        cropped2, bbox2 = self.crop_leaf(image2)
        ...
        padded_gray2, pad_offset = self.pad_image_to_match(gray2, gray1.shape)
        
        # Extract the bottom band of gray1 as the template
        template_band = self.extract_bottom_band(gray1)
        ...
        while cap.isOpened() and frame_count < max_frames:
            ...
            if frame_count % frame_interval == 0:
                ...
                if stitched_result is None:
                    ...
                    stitched_result, last_size = self.stitch_images(stitched_result, frame_resized, last_size)
...
final_stitched_image = imageStitcher.process_video(video_path, frame_interval=10, video_duration=10)
